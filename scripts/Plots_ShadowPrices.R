...
lines(caribou_spcB3$shadowcB3 ~ caribou_spcB3$cariboucB3, lwd =3, lty = 5, col = "dark grey")
lines(caribou_spcB8$shadowcB8 ~ caribou_spcB8$cariboucB8, lwd =3, lty = 3, col = "dark grey")
lines(caribou_spcC3$shadowcC3 ~ caribou_spcC3$cariboucC3, lwd =3, lty = 3, col = "purple")
lines(caribou_spcC8$shadowcC8 ~ caribou_spcC8$cariboucC8, lwd =3, lty = 1, col = "purple")
...
lines(wolf_spwB3$shadowwolfwB3 ~ wolf_spwB3$wolveswB3, lwd =3,lty = 5, col = "dark grey")
lines(wolf_spwB8$shadowwolfwB8 ~ wolf_spwB8$wolveswB8, lwd =3,lty = 3, col = "dark grey")
lines(wolf_spwC3$shadowwolfwC3 ~ wolf_spwC3$wolveswC3, lwd =3, lty = 3, col = "purple")
lines(wolf_spwC8$shadowwolfwC8 ~ wolf_spwC8$wolveswC8, lwd =3, lty = 1, col = "purple")
...
lines(prey_spuB3$shadowpreyuB3 ~ prey_spuB3$ungulatesuB3, lwd =3,lty = 5, col = "dark grey")
lines(prey_spuB8$shadowpreyuB8 ~ prey_spuB8$ungulatesuB8, lwd =3,lty = 5, col = "dark grey")
lines(prey_spuC3$shadowpreyuC3 ~ prey_spuC3$ungulatesuC3, lwd =3, lty = 3, col = "purple")
lines(prey_spuC8$shadowpreyuC8 ~ prey_spuC8$ungulatesuC8, lwd =3, lty = 1, col = "purple")
legend("topright", legend = c("Business as Usual", "No Restoration", "Full Restoration"), 
       col = c("black", "black", "dark grey"), 
       lty = c(1,3,5), lwd = c(2,2,2), cex = 1.3)
...
lines(LF_spfA8$shadowLFfA8 ~ LF_spfA8$lfeaturesfA8, lwd =2,lty = 1, col = "black")
lines(LF_spfB3$shadowLFfB3 ~ LF_spfB3$lfeaturesfB3, lwd =3,lty = 3, col = "dark grey")
lines(LF_spfB8$shadowLFfB8 ~ LF_spfB8$lfeaturesfB8, lwd =3,lty = 1, col = "dark grey")
lines(LF_spfC3$shadowLFfC3 ~ LF_spfC3$lfeaturesfC3, lwd =3, lty = 3, col = "purple")
lines(LF_spfC8$shadowLFfC8 ~ LF_spfC8$lfeaturesfC8, lwd =3, lty = 1, col = "purple")
