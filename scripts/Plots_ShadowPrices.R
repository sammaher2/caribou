...
#### PLOTS
#### RUNNING THIS SCRIPT GENERATES 2 SERIES OF PLOTS
#### "pricecurves.tif" gives the price curves for all stocks at a 3% discount rate. Use hashtags to adjust which scenarios are plotted
#### "statedpreference.tif" compares the prices curves for caribou generated by capn with Harper 2012's stated preference survey data

#CARIBOU PRICE CURVES
tiff(P("images/pricecurves.tif"), res=600, compression = "lzw", height= 10, width=12, units="in")
par(mfcol = c(2,2), bty = "o", xaxs = "i", yaxs = "i")
...
axis(side = 2, at=c(0,100000, 200000, 300000, 400000),
     labels=c("0", "100,000", "200,000", "300,000", "400,000"), cex.axis = 1.2 )
lines(caribou_spcA3$shadowcA3 ~ caribou_spcA3$cariboucA3, lwd =3, lty = 3, col = "black")  #No Restoration, 3% discount rate
#lines(caribou_spcA8$shadowcA8 ~ caribou_spcA8$cariboucA8, lwd =3, lty = 1, col = "black")  #No Restoration, 8% discount rate
lines(caribou_spcB3$shadowcB3 ~ caribou_spcB3$cariboucB3, lwd =3, lty = 1, col = "black") #25% restoration (BAU), 3% discount rate
#lines(caribou_spcB8$shadowcB8 ~ caribou_spcB8$cariboucB8, lwd =3, lty = 5, col = "black") #25% restoration (BAU), 8% discount rate
lines(caribou_spcC3$shadowcC3 ~ caribou_spcC3$cariboucC3, lwd =3, lty = 1, col = "purple") #50% restoration (Full), 3% discount rate
#lines(caribou_spcC8$shadowcC8 ~ caribou_spcC8$cariboucC8, lwd =3, lty = 5, col = "purple") #50% restoration (Full), 8% discount rate

##########LEGEND FOR 3 AND 8% DISCOUNT RATES
...
#        lty = c(3,1,5,1,5), lwd = c(2,2,2,2,2), cex = .6)
#dev.off()

##########LEGEND FOR EITHER 3 OR 8 % DISCOUNT RATE (NOT BOTH)
legend("topright", legend = c( "No Restoration","Business as Usual","Full Restoration"), 
       col = c("black", "black", "purple"), 
       lty = c(3,1,1), lwd = c(2,2,2), cex = .6)
...
#CARIBOU
tiff(P("images/statedpreference.tif"), res=600, compression = "lzw", height=5, width=6, units="in")

par(mfcol = c(1,1), bty = "o", xaxs = "i", yaxs = "i")
plot(caribou_spcA3$shadowcA3 ~ caribou_spcA3$cariboucA3,
     xlab="Caribou",
     ylab="Shadow Price (CAD)",
    main = "Revealed and Stated Preference for Caribou",
     cex.main = 1.2,
     cex.lab = 1.4,
     cex = .05,
     col = "white",
...
legend("topright", legend = c("Business as Usual", "Best Case Scenario", "Stated Preference (scale 100x revealed preference)"), 
       ...
       lty = c(1,1,6), lwd = c(2,2,2), cex = .9)

par(new = T)
plot(con_deriv$marginalvalue ~ caribou_spcA3$cariboucA3, pch=16, axes=F, 
     xlab=NA, ylab=NA, cex=1.2, col = 'white', xlim = c(0, 5000),
     ylim = c(0.0, 40000000), xaxt = "n")
axis(side = 4, at=c(0,10000000,20000000,30000000, 40000000), las = 2, cex.axis = 1.0,
     labels=c("0", "10", "20", "30", "40"))
lines(con_deriv$marginalvalue ~ caribou_spcA3$cariboucA3, lwd = 2, lty = 6, col = "blue")
